export const IconBottomVerticalArrow = ({ width = '12', height = '8', color = '#5A646E', ...props }) => {
  return (
    <svg width={width} height={height} viewBox='0 0 12 8' fill='none' xmlns='http://www.w3.org/2000/svg' {...props}>
      <path
