...
export const IconArrow = ({ width = '11', height = '17', color = 'black', ...props }) => {
  return (
    <svg width={width} height={height} viewBox='0 0 11 17' fill='none' xmlns='http://www.w3.org/2000/svg' {...props}>
      <path
