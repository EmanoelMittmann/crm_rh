...
const TimeListing = ({ time }: any) => {
  ...
  return (
    <ContainerShelf>
      ...
      <ContainerProjectColumn width="25%">{time.job}</ContainerProjectColumn>
      <ContainerProjectColumn width="12%">{time.hours}</ContainerProjectColumn>
      <ContainerProjectColumn width="10%">{time.status}</ContainerProjectColumn>
